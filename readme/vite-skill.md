...
- `scripts/main.module.js` 也會輸出 `globalThis.NindouModuleProbeMeta`，目前含 `version`、`sectionKeys`、`sectionCount`、`unsyncedCount`、`generatedAt`，供後續 probe schema 演進與診斷時間點判斷。
