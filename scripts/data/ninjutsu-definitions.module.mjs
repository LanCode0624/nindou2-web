...
export const ninjuByType = Object.fromEntries(ninjuCatalog.map((ninju) => [ninju.type, ninju]));
export const ninjuEditorRowOrder = { heal: 1, support: 2, attack: 3, special: 4, transform: 5 };
export const ninjuEditorCatalog = [...ninjuCatalog].sort((a, b) => (
  (ninjuEditorRowOrder[a.editorRow] || 99) - (ninjuEditorRowOrder[b.editorRow] || 99)
  || a.editorOrder - b.editorOrder
));
export const defaultNinjuLoadout = ["moneyDart", "steel", "hotBlood", "genki", "flash", "death"];

export function summarizeNinjutsuCatalog(legacyCatalog = []) {
