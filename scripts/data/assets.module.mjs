...
export const frameSourceCatalog = {
  ...
  damageSuccessBig: Array.from({ length: 10 }, (_, index) => `assets/ninju/status/damage_success/big/${index + 1}.png`),
  damageSuccessNinjuSuccess: Array.from({ length: 10 }, (_, index) => `assets/ninju/status/damage_success/norm/${index + 1}.png`),
  sevenNinju: Array.from({ length: 43 }, (_, index) => `assets/ninju/special_exports/sprites/DefineSprite_946_Seven/${index + 1}.png`),
